...
namespace FinkiAdventureQuest.FinkiSurvive.code
{
    public partial class Player : CharacterBody2D
    {
        ...
        public override void _Ready()
        {
            ...
            _currentAttackIdx = 0;
            _currentAttack = _currentAttack = GD.Load<PackedScene>(ProjectPaths.AttackScenesPath + BaseAttack.AttackScenes[_currentAttackIdx] + ".tscn").Instantiate<Attack1>();
        ...
        public void SwitchAttack()
        {
            ...
            var attackScene = GD.Load<PackedScene>(ProjectPaths.AttackScenesPath + BaseAttack.AttackScenes[_currentAttackIdx] + ".tscn");
            BaseAttack atk = attackScene.Instantiate() as BaseAttack;
            while (atk!.GetAvailableAtWave() > Main.Game.WaveCount)
            {
                GetNextAttack();
                atk = GD.Load<PackedScene>(ProjectPaths.AttackScenesPath + BaseAttack.AttackScenes[_currentAttackIdx] + ".tscn").Instantiate() as BaseAttack;
            }
        ...
        private void Attack()
        {
            ...
            PackedScene attackScene = GD.Load<PackedScene>(ProjectPaths.AttackScenesPath + BaseAttack.AttackScenes[_currentAttackIdx] + ".tscn");
